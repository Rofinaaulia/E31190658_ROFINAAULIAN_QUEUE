...
public class Antrian {
 ...
 { String antrian[]=new String [16];
     System.out.println("Rofina Aulia Noviati");
...
//program tersebut menggunakan prinsip antrian, yaitu siapa yang masuk duluan 
//maka dialah yang akan keluar duluan.
//jadi pada program di atas ada 6 antrian 
//yaitu mobil A,B,C,D,E dan F. maka yang akan keluar pertama adalah yang mengantri pertama. 
//Misalnya seperti program tersebut. 
//Hanya di keluarkan 5 mobil saja dalam satu pemanggilan. 
//Maka otomatis f akan tetap menunggu. Karena F yang terakhir mengantri.